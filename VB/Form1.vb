...
Namespace WindowsApplication1
	Partial Public Class Form1
		...
		Public Sub New()
            ...
            For Each lookAndFeelItem As LookAndFeelStyle In System.Enum.GetValues(GetType(LookAndFeelStyle))
                rgStyles.Properties.Items.Add(New RadioGroupItem(lookAndFeelItem, lookAndFeelItem.ToString()))
            Next lookAndFeelItem
